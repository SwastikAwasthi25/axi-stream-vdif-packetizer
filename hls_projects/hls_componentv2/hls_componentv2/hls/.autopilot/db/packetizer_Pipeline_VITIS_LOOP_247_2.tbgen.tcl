set moduleName packetizer_Pipeline_VITIS_LOOP_247_2
set isTopModule 0
...
set cdfgNum 5
set C_modelName {packetizer_Pipeline_VITIS_LOOP_247_2}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ fifo int 32 regular {fifo 0 volatile }  }
	{ p_phi_reload int 4 regular  }
	{ p_phi4_reload int 4 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "fifo", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "p_phi4_reload", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ fifo_dout sc_in sc_lv 32 signal 0 } 
	{ fifo_empty_n sc_in sc_logic 1 signal 0 } 
	{ fifo_read sc_out sc_logic 1 signal 0 } 
	{ out_stream_TREADY sc_in sc_logic 1 outacc 3 } 
	{ p_phi_reload sc_in sc_lv 4 signal 1 } 
	{ p_phi4_reload sc_in sc_lv 4 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "p_phi4_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "p_phi4_reload", "role": "default" }} , 
...
set ArgLastReadFirstWriteLatency {
	packetizer_Pipeline_VITIS_LOOP_247_2 {
		fifo {Type I LastRead 1 FirstWrite -1}
		p_phi_reload {Type I LastRead 0 FirstWrite -1}
		p_phi4_reload {Type I LastRead 0 FirstWrite -1}
...
set Spec2ImplPortList { 
	...
	p_phi4_reload { ap_none {  { p_phi4_reload in_data 0 4 } } }
