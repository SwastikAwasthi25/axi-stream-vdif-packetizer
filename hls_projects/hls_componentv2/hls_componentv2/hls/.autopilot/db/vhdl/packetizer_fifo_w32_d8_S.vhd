...
entity packetizer_fifo_w32_d8_S is 
    generic (
...
architecture rtl of packetizer_fifo_w32_d8_S is
...
------------------------Component----------------------
    component packetizer_fifo_w32_d8_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 3;
        DEPTH      : integer := 8);
...
begin
----------------------- Instantiation -----------------------
    U_packetizer_fifo_w32_d8_S_ShiftReg : packetizer_fifo_w32_d8_S_ShiftReg
    generic map (
...
entity packetizer_fifo_w32_d8_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 3;
        DEPTH      : integer := 8);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end packetizer_fifo_w32_d8_S_ShiftReg;

architecture rtl of packetizer_fifo_w32_d8_S_ShiftReg is
