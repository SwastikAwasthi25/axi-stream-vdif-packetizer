...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler packetizer_fifo_w32_d8_S BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {fifo_U}
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler packetizer_regslice_both BINDTYPE {interface} TYPE {adapter} IMPL {reg_slice}
}
