set moduleName sample_packer_Pipeline_VITIS_LOOP_46_3
set isTopModule 0
...
set cdfgNum 6
set C_modelName {sample_packer_Pipeline_VITIS_LOOP_46_3}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ adc_in int 8 regular {axi_s 0 volatile  { adc_in Data } }  }
	{ word_4_out int 32 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "adc_in", "interface" : "axis", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "word_4_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ word_4_out sc_out sc_lv 32 signal 1 } 
	{ word_4_out_ap_vld sc_out sc_logic 1 outvld 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "word_4_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "word_4_out", "role": "default" }} , 
 	{ "name": "word_4_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "word_4_out", "role": "ap_vld" }}  ]}
...
set Spec2ImplPortList { 
	...
	word_4_out { ap_vld {  { word_4_out out_data 1 32 }  { word_4_out_ap_vld out_vld 1 1 } } }
}
