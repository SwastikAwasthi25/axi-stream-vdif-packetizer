...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_fifo \
    op interface \
    ports { fifo_din { O 32 vector } fifo_full_n { I 1 bit } fifo_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_p_phi4_out \
    op interface \
    ports { p_phi4_out { O 4 vector } p_phi4_out_ap_vld { O 1 bit } } \
} "
}
...
set InstName packetizer_flow_control_loop_pipe_sequential_init_U
set CompName packetizer_flow_control_loop_pipe_sequential_init
