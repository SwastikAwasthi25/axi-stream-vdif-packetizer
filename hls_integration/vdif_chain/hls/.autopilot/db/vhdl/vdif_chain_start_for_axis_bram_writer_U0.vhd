...
entity vdif_chain_start_for_axis_bram_writer_U0 is 
    generic (
...
architecture rtl of vdif_chain_start_for_axis_bram_writer_U0 is
...
------------------------Component----------------------
    component vdif_chain_start_for_axis_bram_writer_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_vdif_chain_start_for_axis_bram_writer_U0_ShiftReg : vdif_chain_start_for_axis_bram_writer_U0_ShiftReg
    generic map (
...
entity vdif_chain_start_for_axis_bram_writer_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end vdif_chain_start_for_axis_bram_writer_U0_ShiftReg;

architecture rtl of vdif_chain_start_for_axis_bram_writer_U0_ShiftReg is
