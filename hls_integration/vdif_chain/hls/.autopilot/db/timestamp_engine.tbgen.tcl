set moduleName timestamp_engine
set isTopModule 0
...
set cdfgNum 24
set C_modelName {timestamp_engine}
...
set portList { 
	...
	{ pps_dout sc_in sc_lv 1 signal 0 } 
	{ pps_empty_n sc_in sc_logic 1 signal 0 } 
	{ pps_read sc_out sc_logic 1 signal 0 } 
	{ pps_num_data_valid sc_in sc_lv 3 signal 0 } 
	{ pps_fifo_cap sc_in sc_lv 3 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "pps_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "pps", "role": "num_data_valid" }} , 
 	{ "name": "pps_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "pps", "role": "fifo_cap" }} , 
...
set Spec2ImplPortList { 
	pps { ap_fifo {  { pps_dout fifo_data_out 0 1 }  { pps_empty_n fifo_status_empty 0 1 }  { pps_read fifo_data_in 1 1 }  { pps_num_data_valid fifo_update 0 3 }  { pps_fifo_cap fifo_data 0 3 } } }
}
