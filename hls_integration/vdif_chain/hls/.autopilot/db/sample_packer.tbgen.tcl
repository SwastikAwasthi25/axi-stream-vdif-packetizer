...
set C_modelArgList {
	...
	{ packed_stream int 32 regular {fifo 1 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "adc_in", "interface" : "axis", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "packed_stream", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ packed_stream_din sc_out sc_lv 32 signal 1 } 
	{ packed_stream_full_n sc_in sc_logic 1 signal 1 } 
	{ packed_stream_write sc_out sc_logic 1 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "packed_stream_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "packed_stream", "role": "din" }} , 
 	{ "name": "packed_stream_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "packed_stream", "role": "full_n" }} , 
 	{ "name": "packed_stream_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "packed_stream", "role": "write" }} , 
...
set Spec2ImplPortList { 
	...
	packed_stream { ap_fifo {  { packed_stream_din fifo_data_out 1 32 }  { packed_stream_full_n fifo_status_empty 0 1 }  { packed_stream_write fifo_data_in 1 1 } } }
