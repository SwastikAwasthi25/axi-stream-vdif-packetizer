set moduleName write_payload_Pipeline_VITIS_LOOP_16_1
set isTopModule 0
...
set cdfgNum 24
set C_modelName {write_payload_Pipeline_VITIS_LOOP_16_1}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ payload_words int 16 regular  }
	{ fifo int 32 regular {fifo 0 volatile }  }
	{ add_ln22 int 17 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "payload_words", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "add_ln22", "interface" : "wire", "bitwidth" : 17, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ fifo_num_data_valid sc_in sc_lv 14 signal 1 } 
	{ fifo_fifo_cap sc_in sc_lv 14 signal 1 } 
	{ out_stream_TREADY sc_in sc_logic 1 outacc 3 } 
	{ payload_words sc_in sc_lv 16 signal 0 } 
	{ add_ln22 sc_in sc_lv 17 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add_ln22", "direction": "in", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "add_ln22", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	add_ln22 { ap_none {  { add_ln22 in_data 0 17 } } }
