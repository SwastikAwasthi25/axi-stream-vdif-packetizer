    ...
    reg ap_done_reg_0;// for module packetizer_U0.entry_proc_U0
    always @ (negedge dl_reset or posedge dl_clock) begin
        if (~dl_reset) begin
            ap_done_reg_0 <= 'b0;
        end
        else begin
            ap_done_reg_0 <= packetizer_U0.entry_proc_U0.ap_done & ~packetizer_U0.entry_proc_U0.ap_continue;
        end
    end

    reg ap_done_reg_1;// for module packetizer_U0.header_generator_U0
    always @ (negedge dl_reset or posedge dl_clock) begin
        if (~dl_reset) begin
            ap_done_reg_1 <= 'b0;
        end
        else begin
            ap_done_reg_1 <= packetizer_U0.header_generator_U0.ap_done & ~packetizer_U0.header_generator_U0.ap_continue;
        end
    end

    reg ap_done_reg_2;// for module packetizer_U0.read_payload_U0
    always @ (negedge dl_reset or posedge dl_clock) begin
        if (~dl_reset) begin
            ap_done_reg_2 <= 'b0;
        end
        else begin
            ap_done_reg_2 <= packetizer_U0.read_payload_U0.ap_done & ~packetizer_U0.read_payload_U0.ap_continue;
        end
    end

    reg ap_done_reg_3;// for module packetizer_U0.packetizer_Block_entry_out_stream_V_data_V_wr_proc_U0
    always @ (negedge dl_reset or posedge dl_clock) begin
        if (~dl_reset) begin
            ap_done_reg_3 <= 'b0;
        end
        else begin
            ap_done_reg_3 <= packetizer_U0.packetizer_Block_entry_out_stream_V_data_V_wr_proc_U0.ap_done & ~packetizer_U0.packetizer_Block_entry_out_stream_V_data_V_wr_proc_U0.ap_continue;
        end
    end

    reg ap_done_reg_4;// for module packetizer_U0.packetizer_Block_entry_fsm_state_fb_proc_U0
    always @ (negedge dl_reset or posedge dl_clock) begin
        if (~dl_reset) begin
            ap_done_reg_4 <= 'b0;
        end
        else begin
            ap_done_reg_4 <= packetizer_U0.packetizer_Block_entry_fsm_state_fb_proc_U0.ap_done & ~packetizer_U0.packetizer_Block_entry_fsm_state_fb_proc_U0.ap_continue;
        end
    end

reg [15:0] trans_in_cnt_0;// for process entry_proc7_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_0 <= 16'h0;
    end
    else if (entry_proc7_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_0;// for process entry_proc7_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_0 <= 16'h0;
    end
    else if (entry_proc7_U0.ap_done == 1'b1 && entry_proc7_U0.ap_continue == 1'b1) begin
    ...
    vdif_chain_hls_deadlock_detect_unit #(9, 0, 4, 4) vdif_chain_hls_deadlock_detect_unit_0 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_0_data_FIFO_blk[0] = 1'b0 | (~entry_proc7_U0.epoch_c_blk_n) | (~entry_proc7_U0.station_id_c_blk_n) | (~entry_proc7_U0.thread_id_c_blk_n) | (~entry_proc7_U0.complex_data_c_blk_n) | (~entry_proc7_U0.pps_c_blk_n);
    assign proc_0_data_PIPO_blk[0] = 1'b0;
    assign proc_0_start_FIFO_blk[0] = 1'b0 | (~start_for_packetizer_U0_U.if_full_n & entry_proc7_U0.ap_start & ~entry_proc7_U0.real_start & (trans_in_cnt_0 == trans_out_cnt_0) & ~start_for_packetizer_U0_U.if_read);
    assign proc_0_TLF_FIFO_blk[0] = 1'b0;
    assign proc_0_input_sync_blk[0] = 1'b0;
    assign proc_0_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_0[0] = dl_detect_out ? proc_dep_vld_vec_0_reg[0] : (proc_0_data_FIFO_blk[0] | proc_0_data_PIPO_blk[0] | proc_0_start_FIFO_blk[0] | proc_0_TLF_FIFO_blk[0] | proc_0_input_sync_blk[0] | proc_0_output_sync_blk[0]);
    assign proc_0_data_FIFO_blk[1] = 1'b0 | (~entry_proc7_U0.epoch_c_blk_n) | (~entry_proc7_U0.station_id_c_blk_n) | (~entry_proc7_U0.thread_id_c_blk_n) | (~entry_proc7_U0.complex_data_c_blk_n);
    ...
    assign proc_0_data_FIFO_blk[2] = 1'b0 | (~entry_proc7_U0.pps_c_blk_n);
    ...
    assign proc_0_input_sync_blk[3] = 1'b0 | (ap_sync_entry_proc7_U0_ap_ready & entry_proc7_U0.ap_idle & ~ap_sync_Loop_VITIS_LOOP_71_1_proc_U0_ap_ready);
    ...
    // Process: Loop_VITIS_LOOP_71_1_proc_U0
    vdif_chain_hls_deadlock_detect_unit #(9, 1, 4, 4) vdif_chain_hls_deadlock_detect_unit_1 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_1_data_FIFO_blk[0] = 1'b0 | (~Loop_VITIS_LOOP_71_1_proc_U0.packetizer_in_blk_n) | (~Loop_VITIS_LOOP_71_1_proc_U0.bits_per_sample_c_blk_n) | (~Loop_VITIS_LOOP_71_1_proc_U0.payload_words_c_blk_n);
    ...
    assign proc_1_data_FIFO_blk[1] = 1'b0 | (~Loop_VITIS_LOOP_71_1_proc_U0.packetizer_in_blk_n);
    ...
    assign proc_1_data_FIFO_blk[2] = 1'b0 | (~Loop_VITIS_LOOP_71_1_proc_U0.bits_per_sample_c_blk_n) | (~Loop_VITIS_LOOP_71_1_proc_U0.payload_words_c_blk_n);
    ...
    assign proc_1_input_sync_blk[3] = 1'b0 | (ap_sync_Loop_VITIS_LOOP_71_1_proc_U0_ap_ready & Loop_VITIS_LOOP_71_1_proc_U0.ap_idle & ~ap_sync_entry_proc7_U0_ap_ready);
    ...
    // Process: packetizer_U0
    vdif_chain_hls_deadlock_detect_unit #(9, 2, 2, 2) vdif_chain_hls_deadlock_detect_unit_2 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_2_data_FIFO_blk[0] = 1'b0 | (~packetizer_U0.read_payload_U0.packetizer_in_blk_n) | (~packetizer_U0.entry_proc_U0.bits_per_sample_blk_n) | (~packetizer_U0.entry_proc_U0.payload_words_blk_n);
    ...
    assign proc_2_data_FIFO_blk[1] = 1'b0 | (~packetizer_U0.entry_proc_U0.epoch_blk_n) | (~packetizer_U0.entry_proc_U0.station_id_blk_n) | (~packetizer_U0.entry_proc_U0.thread_id_blk_n) | (~packetizer_U0.entry_proc_U0.complex_data_blk_n) | (~packetizer_U0.timestamp_engine_U0.pps_blk_n);
    assign proc_2_data_PIPO_blk[1] = 1'b0;
    assign proc_2_start_FIFO_blk[1] = 1'b0 | (~start_for_packetizer_U0_U.if_empty_n & packetizer_U0.ap_idle & ~start_for_packetizer_U0_U.if_write);
    ...
    // Process: packetizer_U0.entry_proc_U0
    vdif_chain_hls_deadlock_detect_unit #(9, 3, 6, 6) vdif_chain_hls_deadlock_detect_unit_3 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_3_TLF_FIFO_blk[0] = 1'b0 | (~packetizer_U0.p_channel_U.if_full_n & packetizer_U0.entry_proc_U0.ap_done & ap_done_reg_0 & ~packetizer_U0.p_channel_U.if_read);
    assign proc_3_input_sync_blk[0] = 1'b0;
    assign proc_3_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_3[0] = dl_detect_out ? proc_dep_vld_vec_3_reg[0] : (proc_3_data_FIFO_blk[0] | proc_3_data_PIPO_blk[0] | proc_3_start_FIFO_blk[0] | proc_3_TLF_FIFO_blk[0] | proc_3_input_sync_blk[0] | proc_3_output_sync_blk[0]);
    assign proc_3_data_FIFO_blk[1] = 1'b0 | (~packetizer_U0.entry_proc_U0.epoch_blk_n) | (~packetizer_U0.entry_proc_U0.station_id_blk_n) | (~packetizer_U0.entry_proc_U0.thread_id_blk_n) | (~packetizer_U0.entry_proc_U0.complex_data_blk_n);
    ...
    assign proc_3_data_FIFO_blk[2] = 1'b0 | (~packetizer_U0.entry_proc_U0.epoch_c_blk_n) | (~packetizer_U0.entry_proc_U0.station_id_c_blk_n) | (~packetizer_U0.entry_proc_U0.thread_id_c_blk_n) | (~packetizer_U0.entry_proc_U0.bits_per_sample_c_blk_n) | (~packetizer_U0.entry_proc_U0.complex_data_c_blk_n) | (~packetizer_U0.entry_proc_U0.payload_words_c1_blk_n);
    ...
    assign proc_3_data_FIFO_blk[3] = 1'b0 | (~packetizer_U0.entry_proc_U0.bits_per_sample_blk_n) | (~packetizer_U0.entry_proc_U0.payload_words_blk_n);
    ...
    assign proc_3_input_sync_blk[4] = 1'b0 | (packetizer_U0.ap_sync_entry_proc_U0_ap_ready & packetizer_U0.entry_proc_U0.ap_idle & ~packetizer_U0.ap_sync_timestamp_engine_U0_ap_ready);
    ...
    assign proc_3_input_sync_blk[5] = 1'b0 | (packetizer_U0.ap_sync_entry_proc_U0_ap_ready & packetizer_U0.entry_proc_U0.ap_idle & ~packetizer_U0.ap_sync_packetizer_Block_entry_fsm_state_fb_proc_U0_ap_ready);
    ...
    // Process: packetizer_U0.timestamp_engine_U0
    vdif_chain_hls_deadlock_detect_unit #(9, 4, 4, 3) vdif_chain_hls_deadlock_detect_unit_4 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_4_data_FIFO_blk[0] = 1'b0 | (~packetizer_U0.timestamp_engine_U0.pps_blk_n);
    ...
    assign proc_4_input_sync_blk[1] = 1'b0 | (packetizer_U0.ap_sync_timestamp_engine_U0_ap_ready & packetizer_U0.timestamp_engine_U0.ap_idle & ~packetizer_U0.ap_sync_entry_proc_U0_ap_ready);
    ...
    assign proc_4_input_sync_blk[2] = 1'b0 | (packetizer_U0.ap_sync_timestamp_engine_U0_ap_ready & packetizer_U0.timestamp_engine_U0.ap_idle & ~packetizer_U0.ap_sync_packetizer_Block_entry_fsm_state_fb_proc_U0_ap_ready);
    ...
    assign in_chan_dep_data_vec_4[35 : 27] = dep_chan_data_6_4;
    ...
    // Process: packetizer_U0.packetizer_Block_entry_fsm_state_fb_proc_U0
    vdif_chain_hls_deadlock_detect_unit #(9, 5, 3, 3) vdif_chain_hls_deadlock_detect_unit_5 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_5_input_sync_blk[0] = 1'b0 | (packetizer_U0.ap_sync_packetizer_Block_entry_fsm_state_fb_proc_U0_ap_ready & packetizer_U0.packetizer_Block_entry_fsm_state_fb_proc_U0.ap_idle & ~packetizer_U0.ap_sync_entry_proc_U0_ap_ready);
    ...
    assign proc_5_input_sync_blk[1] = 1'b0 | (packetizer_U0.ap_sync_packetizer_Block_entry_fsm_state_fb_proc_U0_ap_ready & packetizer_U0.packetizer_Block_entry_fsm_state_fb_proc_U0.ap_idle & ~packetizer_U0.ap_sync_timestamp_engine_U0_ap_ready);
    ...
    assign proc_5_output_sync_blk[2] = 1'b0 | (ap_done_reg_4 & packetizer_U0.packetizer_Block_entry_fsm_state_fb_proc_U0.ap_done & ~packetizer_U0.packetizer_Block_entry_out_stream_V_data_V_wr_proc_U0.ap_done);
    ...
    // Process: packetizer_U0.header_generator_U0
    vdif_chain_hls_deadlock_detect_unit #(9, 6, 2, 3) vdif_chain_hls_deadlock_detect_unit_6 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_6_TLF_FIFO_blk[0] = 1'b0 | (~packetizer_U0.seconds_from_epoch_U.if_empty_n & packetizer_U0.header_generator_U0.ap_idle & ~packetizer_U0.seconds_from_epoch_U.if_write) | (~packetizer_U0.frame_no_U.if_empty_n & packetizer_U0.header_generator_U0.ap_idle & ~packetizer_U0.frame_no_U.if_write);
    assign proc_6_input_sync_blk[0] = 1'b0;
    assign proc_6_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_6[0] = dl_detect_out ? proc_dep_vld_vec_6_reg[0] : (proc_6_data_FIFO_blk[0] | proc_6_data_PIPO_blk[0] | proc_6_start_FIFO_blk[0] | proc_6_TLF_FIFO_blk[0] | proc_6_input_sync_blk[0] | proc_6_output_sync_blk[0]);
    assign proc_6_data_FIFO_blk[1] = 1'b0 | (~packetizer_U0.header_generator_U0.epoch_blk_n) | (~packetizer_U0.header_generator_U0.station_id_blk_n) | (~packetizer_U0.header_generator_U0.thread_id_blk_n) | (~packetizer_U0.header_generator_U0.bits_per_sample_blk_n) | (~packetizer_U0.header_generator_U0.complex_data_blk_n) | (~packetizer_U0.header_generator_U0.payload_words_blk_n);
    ...
    assign proc_6_data_PIPO_blk[2] = 1'b0 | (~packetizer_U0.header_U.i_full_n & packetizer_U0.header_generator_U0.ap_done & ap_done_reg_1 & ~packetizer_U0.header_U.t_read);
    ...
    // Process: packetizer_U0.read_payload_U0
    vdif_chain_hls_deadlock_detect_unit #(9, 7, 3, 3) vdif_chain_hls_deadlock_detect_unit_7 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_7_data_FIFO_blk[0] = 1'b0 | (~packetizer_U0.read_payload_U0.packetizer_in_blk_n);
    ...
    assign proc_7_data_FIFO_blk[1] = 1'b0 | (~packetizer_U0.read_payload_U0.fifo_blk_n);
    ...
    assign proc_7_TLF_FIFO_blk[2] = 1'b0 | (~packetizer_U0.p_channel_U.if_empty_n & packetizer_U0.read_payload_U0.ap_idle & ~packetizer_U0.p_channel_U.if_write);
    ...
    assign in_chan_dep_data_vec_7[17 : 9] = dep_chan_data_3_7;
    ...
    // Process: packetizer_U0.packetizer_Block_entry_out_stream_V_data_V_wr_proc_U0
    vdif_chain_hls_deadlock_detect_unit #(9, 8, 3, 3) vdif_chain_hls_deadlock_detect_unit_8 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_8_data_PIPO_blk[0] = 1'b0 | (~packetizer_U0.header_U.t_empty_n & packetizer_U0.packetizer_Block_entry_out_stream_V_data_V_wr_proc_U0.ap_idle & ~packetizer_U0.header_U.i_write);
    assign proc_8_start_FIFO_blk[0] = 1'b0;
    assign proc_8_TLF_FIFO_blk[0] = 1'b0 | (~packetizer_U0.payload_words_c_channel_U.if_empty_n & packetizer_U0.packetizer_Block_entry_out_stream_V_data_V_wr_proc_U0.ap_idle & ~packetizer_U0.payload_words_c_channel_U.if_write);
    assign proc_8_input_sync_blk[0] = 1'b0;
    assign proc_8_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_8[0] = dl_detect_out ? proc_dep_vld_vec_8_reg[0] : (proc_8_data_FIFO_blk[0] | proc_8_data_PIPO_blk[0] | proc_8_start_FIFO_blk[0] | proc_8_TLF_FIFO_blk[0] | proc_8_input_sync_blk[0] | proc_8_output_sync_blk[0]);
    assign proc_8_data_FIFO_blk[1] = 1'b0 | (~packetizer_U0.packetizer_Block_entry_out_stream_V_data_V_wr_proc_U0.grp_write_payload_fu_64.grp_write_payload_Pipeline_VITIS_LOOP_16_1_fu_44.fifo_blk_n);
    ...
    assign proc_8_output_sync_blk[2] = 1'b0 | (ap_done_reg_3 & packetizer_U0.packetizer_Block_entry_out_stream_V_data_V_wr_proc_U0.ap_done & ~packetizer_U0.packetizer_Block_entry_fsm_state_fb_proc_U0.ap_done);
    ...
    assign in_chan_dep_data_vec_8[8 : 0] = dep_chan_data_5_8;
...
`include "vdif_chain_hls_deadlock_report_unit.vh"
