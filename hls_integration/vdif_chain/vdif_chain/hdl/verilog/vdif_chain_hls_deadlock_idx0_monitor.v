...
module vdif_chain_hls_deadlock_idx0_monitor ( // for module vdif_chain_vdif_chain_inst
    input wire clock,
    input wire reset,
...
assign process_axis_block_vec[2] = idx6_block & (1'b0 | axis_block_sigs[3] | axis_block_sigs[4]);
...
// instant sub module
 vdif_chain_hls_deadlock_idx1_monitor vdif_chain_hls_deadlock_idx1_monitor_U (
    .clock(clock),
    .reset(reset),
 ...
 vdif_chain_hls_deadlock_idx6_monitor vdif_chain_hls_deadlock_idx6_monitor_U (
    .clock(clock),
    .reset(reset),
    .axis_block_sigs(axis_block_sigs),
    .inst_idle_sigs(inst_idle_sigs),
