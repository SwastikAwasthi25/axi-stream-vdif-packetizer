...
module vdif_chain_write_payload_Pipeline_VITIS_LOOP_16_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] icmp_ln22_reg_150;
reg    ap_block_pp0_stage0_11001;
reg   [15:0] i_fu_64;
wire   [15:0] i_2_fu_119_p2;
wire    ap_loop_init;
reg   [15:0] ap_sig_allocacmp_i_1;
wire    ap_block_pp0_stage0;
reg    ap_block_pp0_stage0_11001_grp1;
reg    ap_block_pp0_stage0_01001_grp1;
wire   [16:0] zext_ln22_fu_125_p1;
reg    ap_done_reg;
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1_grp1 = ((out_stream_TREADY == 1'b0) | (fifo_empty_n == 1'b0));
end
...
assign i_2_fu_119_p2 = (ap_sig_allocacmp_i_1 + 16'd1);

assign icmp_ln16_fu_113_p2 = ((ap_sig_allocacmp_i_1 == payload_words) ? 1'b1 : 1'b0);

assign icmp_ln22_fu_129_p2 = ((add_ln22 == zext_ln22_fu_125_p1) ? 1'b1 : 1'b0);

assign out_stream_TDATA = fifo_dout;

assign out_stream_TKEEP = 4'd15;

assign out_stream_TLAST = icmp_ln22_reg_150;

assign out_stream_TSTRB = 4'd15;

assign zext_ln22_fu_125_p1 = ap_sig_allocacmp_i_1;

endmodule //vdif_chain_write_payload_Pipeline_VITIS_LOOP_16_1
