...
entity vdif_chain_fifo_w16_d2_S is 
    generic (
...
architecture rtl of vdif_chain_fifo_w16_d2_S is
...
------------------------Component----------------------
    component vdif_chain_fifo_w16_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 16;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_vdif_chain_fifo_w16_d2_S_ShiftReg : vdif_chain_fifo_w16_d2_S_ShiftReg
    generic map (
...
entity vdif_chain_fifo_w16_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 16;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end vdif_chain_fifo_w16_d2_S_ShiftReg;

architecture rtl of vdif_chain_fifo_w16_d2_S_ShiftReg is
